...
class LineGraph extends React.Component {
    componentDidMount() {
        ...
        var canvas = document.getElementById('myCanvasDeadlift');
        ...
        var data = [
            ...
            { x: new Date('2022-01-03'), y: 20 },
            { x: new Date('2022-01-04'), y: 10 },
            { x: new Date('2022-01-05'), y: 20 }
        ];
    ...
    render() {
        return (
            <canvas id="myCanvasDeadlift" width={500} height={300} />
        );
    }
}
