            ...
            <div className="main-page-wrapper">
                ...
                <div className="main-page-middle-top-left">
                    ...
                    <div className="main-page-three-bottom main-page-three-master">
                        ...
                        <span className='centering-flex text-white '><MyAreaChart excercise={'Squat Weight'} /></span>
                    </div>
                </div>
                <div className="main-page-middle-top-middle">
                    ...
                    <div className="main-page-three-bottom main-page-three-master">
                        ...
                        <span className='centering-flex text-white '><MyAreaChart excercise={'Bench Weight'}/></span>
                    </div>
                </div>
                <div className="main-page-middle-top-right">
                    ...
                    <div className="main-page-three-bottom main-page-three-master">
                        ...
                        <span className='centering-flex text-white '><MyAreaChart excercise={'Deadlift Weight'}/></span>
                    </div>
                </div>
